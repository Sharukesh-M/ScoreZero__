...
# Registered with url_prefix='/auth' in run.py
# So routes here are: /auth/signup, /auth/login, /auth/logout, /auth/me
...
def get_me():
    try:
        ...
        # Fallback: return user data extracted from the token by the middleware
        return jsonify({
            "user": {
