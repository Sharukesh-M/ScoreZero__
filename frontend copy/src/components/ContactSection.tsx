...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="h-screen w-full bg-white text-black font-sans px-4 md:px-8 lg:px-12 overflow-hidden flex items-center justify-center relative">
      <motion.div
        ...
        <div className="lg:col-span-7 flex flex-col justify-between h-full py-2">
          <motion.div variants={itemVariants} className="mb-8 lg:mb-0">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase leading-[0.9] tracking-tight text-left">
              Contact <br />
              <span className="text-[#00B4D8]">Us</span> <span className="inline-block ml-2">→</span>
            </h1>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-8 lg:mt-0 hidden lg:block">
            ...
            <p className="text-base md:text-lg font-normal leading-relaxed text-black/80 max-w-md text-left">
              Have questions, feedback, or inquiries? Send us a message and our team will get back to you promptly.
            </p>
          </motion.div>
        </div>
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                className="w-full bg-transparent border-b border-black/30 py-1 text-lg font-medium focus:border-black focus:outline-none transition-colors resize-none placeholder:text-black/30"
                required
              />
            </div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <button
                ...
                className="group flex items-center gap-3 text-lg font-bold uppercase tracking-wider hover:text-[#00B4D8] transition-colors disabled:opacity-50"
              >
              ...
              {status === "success" && (
                <p className="text-sm text-green-600 font-medium">✓ Message sent! We will get back to you shortly.</p>
              )}
              {status === "error" && (
