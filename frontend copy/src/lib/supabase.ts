...
const supabaseUrl =
  import.meta.env.VITE_SUPABASE_URL || 'https://ckwjxaphxscgraiewewa.supabase.co';
const supabaseAnonKey =
  import.meta.env.VITE_SUPABASE_ANON_KEY || 'sb_publishable_tr5u8DOe-jj4OQnYjc2AiA_SkjbDCsD';
